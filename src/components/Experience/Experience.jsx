...
//           <div
//             key={experience.id}
//             className={`flex flex-col sm:flex-row items-center mb-16  justify-between px-20  -inset-90  ${
...
const Experience = () => {
  return (
    ...
    >
      {/* Section Title */}
      <div className="text-center mb-16">
        <h2 className="text-4xl font-bold text-white">EXPERIENCE & LEARNING</h2>
        <div className="w-96 h-1 bg-purple-500 mx-auto mt-4"></div>
        <p className="text-gray-400 mt-4 text-lg font-semibold">
          A showcase of my work experiences and the technical skills I've gained through various roles and learning programs.
        </p>
      </div>
